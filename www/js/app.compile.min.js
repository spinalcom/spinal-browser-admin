...
angular.module('app.controllers').controller('navbarCtrl',['$scope','authService','$location','goldenLayoutService',function(a,b,c,d){a.username='',a.connected=!1,b.wait_connect().then(()=>{a.username=b.get_user().username,a.connected=!0}),a.logout=()=>{c.path('/login')},a.layouts=[{id:'drag-folder-explorer',name:'Folder Explorer',cfg:{isClosable:!0,title:'Folder Explorer',type:'component',width:20,componentName:'SpinalHome',componentState:{template:'sideBar.html',module:'app.sidebar',controller:'sideBarCtrl'}}},{id:'drag-file-explorer',name:'File Explorer',cfg:{isClosable:!0,title:'File Explorer',type:'component',componentName:'SpinalHome',componentState:{template:'FileExplorer.html',module:'app.FileExplorer',controller:'FileExplorerCtrl'}}},{id:'drag-inspector',name:'Inspector',cfg:{isClosable:!0,title:'Inspector',type:'component',componentName:'SpinalHome',componentState:{template:'inspector.html',controller:'InspectorCtrl'}}}];for(var e=0;e<a.layouts.length;e++)d.registerPannel(a.layouts[e])}]);
